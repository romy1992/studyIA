...
grid_search = GridSearchCV(estimator=pipeline, param_grid=params, verbose=2, scoring='accuracy', cv=5, n_jobs=-1)
...
# Salva il modello
joblib.dump(grid_search.best_estimator_, 'best_model_medical.pkl')
