...
dataset = pd.read_csv('vendite_auto.csv')
...
grid_search = GridSearchCV(estimator=pipeline, param_grid=params, n_jobs=-1, cv=5, verbose=2,
...
# Salva il modello
joblib.dump(grid_search.best_estimator_, 'best_model_auto.pkl')
